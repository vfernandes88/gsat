...
namespace Cit.Globosat.Remuneracao.Formularios.WebParts.ReqPessoalEstagVWP
{
    ...
    public class ReqPessoalEstagVWP : WebPart
    {
        [WebBrowsable(true),
        ...
        private const string _ascxPath = @"~/_CONTROLTEMPLATES/Cit.Globosat.Remuneracao.Formularios.WebParts/ReqPessoalEstagVWP/ReqPessoalEstagVWPUserControl.ascx";

        protected override void CreateChildControls()
        {
            ReqPessoalEstagVWPUserControl control = (ReqPessoalEstagVWPUserControl)Page.LoadControl(_ascxPath);
