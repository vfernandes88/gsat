...
namespace Globosat.Library.AcessoDados
{
    public class AcessoDados
    {
        ...
        public static DataTable GetCentroCustoAtivosVazios(string matricula, string coligada)
        {
            try
            {
                string sql = string.Format(@"SELECT distinct CODSECAO, DESCRICAO, (CODSECAO + ' - ' + DESCRICAO) AS COD_DESC 
                                          FROM LK_RM..INT_SHAREP_RM.VW_CCUSTO_INTRANET 
